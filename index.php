...
// Определяем базовый URL текущего сайта
$baseUrl = (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['SERVER_ADDR'];
$provisionUrlIp = $baseUrl . '/provision.php';
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="provisionLink" value="<?= htmlspecialchars($provisionUrlIp) ?>" readonly>
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Ссылка на автопрожинг для ручного указания в телефоне:</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="provisionLink2" value="<?= htmlspecialchars($provisionUrl) ?>" readonly>
                        <button class="btn btn-outline-secondary copy-btn" type="button" data-clipboard-target="#provisionLink2">Копировать</button>
                    </div>
                    <small class="text-muted">Нажмите на поле или кнопку, чтобы скопировать</small>
                </div>
            </div>
